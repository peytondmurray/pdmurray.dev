...
Spotify web player to run in Vivaldi (actually any web browser, but Vivaldi is my favorite). So I've
been stuck using the awful native Spotify player available on the AUR. I'm happy to report that I've
just figured out how to get the web player working, and it's super easy. Incidentally, some youtube
videos also refuse to play (but not all) (?).
